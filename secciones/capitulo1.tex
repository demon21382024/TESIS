...
\begin{enumerate}
    ...
    \item Implementar el modelo propuesto utilizando un conjunto de datos no etiquetado de gran escala para el pre-entrenamiento y datasets etiquetados estándar (CASIA-B, OUMVLP, Gait3D) para el entrenamiento supervisado.
...
La presente investigación se justifica desde tres perspectivas complementarias: metodológica, práctica y social. Desde el punto de vista metodológico, este trabajo busca superar las limitaciones de los enfoques híbridos actuales en el reconocimiento de marcha. Aunque existen propuestas que combinan el aprendizaje supervisado y el autosupervisado \citep{Li2020SemiSupGait}, la mayoría lo hace de manera secuencial, sin lograr una integración efectiva entre ambos paradigmas. En este contexto, la investigación propone un marco unificado que permita la interacción sinérgica entre las dos estrategias de aprendizaje, contribuyendo así al desarrollo de modelos más equilibrados entre precisión y capacidad de generalización.
